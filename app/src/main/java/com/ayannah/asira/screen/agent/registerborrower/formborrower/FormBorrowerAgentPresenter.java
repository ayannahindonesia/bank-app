...
public class FormBorrowerAgentPresenter implements FormBorrowerAgentContract.Presenter {

    @Nullable
    private FormBorrowerAgentContract.View mView;
    ...
    @Inject
    FormBorrowerAgentPresenter(Application application, RemoteRepository remotRepo, PreferenceRepository preferenceRepository){
    ...
    @Override
    public void takeView(FormBorrowerAgentContract.View view) {
