...
public class EditInfoPribadiActivity extends DaggerAppCompatActivity implements
        EditInfoPribadiContract.View,
        Validator.ValidationListener{

    @Inject
    EditInfoPribadiContract.Presenter mPresenter;
    ...
    public void loadInfoPribadi(PreferenceRepository data) {
        ...
        try {
            ...
            tvDateBirth.setText(displayFormat.format(date));
    ...
    public void showProvices(List<Provinsi.Data> provinces) {
        ...
        spProvinsi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0){
                    Toast.makeText(EditInfoPribadiActivity.this, names.get(position), Toast.LENGTH_SHORT).show();
...
//        });
    ...
    @Override
    public void successUpfateInfoPribadi() {
